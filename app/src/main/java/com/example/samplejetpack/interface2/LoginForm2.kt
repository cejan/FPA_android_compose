package com.example.samplejetpack.interface2

import android.app.Activity
import com.example.samplejetpack.MainActivity
...
fun PasswordField(
    ...
    val trailingIcon = @Composable {
        IconButton(onClick = { isPasswordVisible = !isPasswordVisible }) {
            Icon(
                if (isPasswordVisible) Icons.Default.Info else Icons.Default.Edit,
                contentDescription = "",
                tint = MaterialTheme.colorScheme.primary
            )
        }
